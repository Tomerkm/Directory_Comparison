...
FOLDER_FILES_TYPE_ZIP_NAME = "files_type_zip"
FOLDER_FILES_TYPE_ZIP_NAME_2 = "files_type_zip_2"
FOLDER_FILES_TYPE_IMG = "files_type_img"
FOLDER_FILES_TYPE_IMG_2 = "files_type_img_2"

CURR_FOLDER_PATH = os.path.dirname(os.path.realpath(__file__))
CONFIG_FILE_NAME = os.path.join(CURR_FOLDER_PATH, "config.ini")
OUTPUT_RESULT = os.path.join(CURR_FOLDER_PATH, "output_result")
OUTPUT_RESULT_PDF = os.path.join(OUTPUT_RESULT, "pdf")
...
FOLDER_FILES_TYPE_ZIP_PATH = os.path.join(FOLDERS_FILES_PATH, FOLDER_FILES_TYPE_ZIP_NAME)
FOLDER_FILES_TYPE_ZIP_2_PATH = os.path.join(FOLDERS_FILES_PATH, FOLDER_FILES_TYPE_ZIP_NAME_2)
FOLDER_FILES_TYPE_IMG_PATH = os.path.join(FOLDERS_FILES_PATH, FOLDER_FILES_TYPE_IMG)
FOLDER_FILES_TYPE_IMG_PATH_2 = os.path.join(FOLDERS_FILES_PATH, FOLDER_FILES_TYPE_IMG_2)
...
DATA_FILES_ZIP_CMP_SIZE = [(FOLDER_FILES_TYPE_ZIP_PATH, FOLDER_FILES_TYPE_ZIP_2_PATH)]
DATA_FILES_IMG_CMP = [(FOLDER_FILES_TYPE_IMG_PATH, FOLDER_FILES_TYPE_IMG_PATH_2)]
